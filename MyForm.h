...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			// textBox1
			// 
			this->textBox1->Location = System::Drawing::Point(312, 47);
			...
			// textBox2
			// 
			this->textBox2->Location = System::Drawing::Point(312, 73);
			...
			this->label1->Location = System::Drawing::Point(358, 50);
			this->label1->Name = L"label1";
			this->label1->Size = System::Drawing::Size(135, 13);
			this->label1->TabIndex = 3;
			this->label1->Text = L"Вероятность добавления";
			this->label1->Click += gcnew System::EventHandler(this, &MyForm::label1_Click_1);
			// 
			// label2
			// 
			this->label2->AutoSize = true;
			this->label2->Location = System::Drawing::Point(358, 76);
			this->label2->Name = L"label2";
			this->label2->Size = System::Drawing::Size(136, 13);
			this->label2->TabIndex = 4;
			this->label2->Text = L"Вероятность исключения";
			// 
			// MyForm
			// 
			this->AutoScaleDimensions = System::Drawing::SizeF(6, 13);
			this->AutoScaleMode = System::Windows::Forms::AutoScaleMode::Font;
			this->ClientSize = System::Drawing::Size(545, 261);
